                                ...
                                <form id="msform">
                                    ...
                                    <fieldset id="Product-Details">
                                        <div class="form-card">
                                            ...
                                            <input type="text" name="productName" id="productName" placeholder="Product Name (Eg. Camping Tent)" />
                                    ...
                                    <fieldset id="Rental-Details">
                                        <div class="form-card">
                                            ...
                                            <div class="expected-rent">
                                                ...
                                                <input type="number" name="dayRent" placeholder="Rent Per Day" />
                                                <input type="number" name="weekRent" placeholder="Rent Per Week" />
                                                <input type="number" name="monthRent" placeholder="Rent Per Month" />
                                            </div>
